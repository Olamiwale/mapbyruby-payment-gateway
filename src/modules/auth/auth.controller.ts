...
export class AuthController {
  ...
  static async register(req: Request<{}, {}, RegisterInput>, res: Response, next: NextFunction) {
    try {
  ...
  static async refreshToken(req: Request<{}, {}, RefreshTokenInput>, res: Response, next: NextFunction) {
    try {
